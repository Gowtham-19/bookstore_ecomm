    ...
    <Row>
      ...
      <Col lg={6} md={6} sm={12}>
        <Container className='contact'>
          ...
          <Row>
            <Col>
              <ImFacebook2 color="blue" style={{ height: "40px", width: "70px" }} />(Facebook)
            </Col>
            <Col>
              <ImInstagram color="purple" style={{ height: "40px", width: "70px" }} />(Instagram)
            </Col>
            <Col>
              <ImTwitter color='skyblue' style={{ height: "40px", width: "70px" }} />(Twitter)
            </Col>
          </Row>
        </Container>
      </Col>
